<?php
/**
 * Enhanced Tooths Schema Definition
 * 
 * Extends the base tooths schema with project status tracking capabilities
 * Follows Rake schema conventions for consistency
 */
return [
    'table' => 'rake_tooths',
    'engine' => 'InnoDB',
    ...
    'fields' => [
        ...
        'status' => [
            ...
            'length' => 32,
            'default' => 'draft',
            'comment' => 'Project status: draft, active, running, completed, failed, partial, paused, cancelled',
        ],
        'completion_percentage' => [
            'type' => 'decimal',
            'length' => '5,2',
            'default' => '0.00',
            'comment' => 'Project completion percentage (0.00-100.00)',
        ],
        'last_status_update' => [
            'type' => 'datetime',
            'nullable' => true,
        ...
        'metadata' => [
            'type' => 'longtext',
            'nullable' => true,
            'comment' => 'Additional project metadata (JSON)',
        ],
        'created_at' => [
            'type' => 'datetime',
